...
from schemas.users import UserPublicSchema, UserSchema
...
class UsersManager:
    ...
    async def create(self, user: UserSchema) -> UserPublicSchema:
        try:
            ...
            return UserPublicSchema._from_dto(user=db_user)
